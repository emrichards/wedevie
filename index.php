...
<?php
	...
	$conn = ConnectToDatabase(vehicleregserver.database.windows.net);

	// // Get data for vehicle registration categories
	// $tsql="SELECT CATEGORY FROM VehicleRegistration ORDER BY CATEGORY ASC";
...
<div class="intro">
	...
	<!-- Display redundant error message on top of webpage if there is an error  <?php echo $prevSelections['errorMessage'] ?> -->
